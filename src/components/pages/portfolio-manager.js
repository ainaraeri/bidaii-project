...
export default class PortfolioManager extends Component {
  ...
  handleDeleteClick(portfolioItem) {
    axios
      .delete(
        `https://ainaraerice.devcamp.space/portfolio/portfolio_items/${portfolioItem.id}`,
  ...
  getPortfolioItems() {
    axios
      .get(
        "https://ainaraerice.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc",
        {
          withCredentials: true,
        }
      )
